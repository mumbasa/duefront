			...
			<div class="row mb-2" key={new Date()}>
				...
				<div class="col-md-2 mb-10">
					<select
						...
						<option>1 for yes and 0 for no</option>
							</select>
				</div>
				...
				<div class="col-md-3 mb-10">
					...
					<button class="btn btn-danger ml-2" type="button" onclick="Submit()">Delete Question
					</button>
				</div>
				...
				<div class="card shadow mb-4">
					...
					<div class="card-body">
						<form>
							...
							<hr />
							<h6 class="form-group">Question Details</h6>
